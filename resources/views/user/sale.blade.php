@extends('master')
@section('title','Регистрация пассажира')
@section('content')
    <div class="row d-flex flex-column text-center align-content-center justify-content-center">
        <h3>Заполните ФИО и номер, серию документа пассажира</h3>
            <div class="col-4" id="passenger-card">
                <form id="registerPassenger" action="/profile/sale/add/{{$book_id}}" method="post">
                    @csrf
                <p>Фамилия</p>
                ...
                <input type="text" class="form-control" id="pass" placeholder="____-______" name="pass" required>
